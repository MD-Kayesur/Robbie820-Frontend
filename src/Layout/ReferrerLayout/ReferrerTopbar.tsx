...
export default function ReferrerTopbar({ onOpenSidebar }: Props) {
  ...
  return (
    <>
      <header className="relative z-40 w-full bg-white px-4 pt-5 sm:px-5 sm:pt-6 md:px-6 md:pt-8 xl:px-7.5 xl:pt-11">
        {/* Mobile navbar */}
        <div className="flex items-center justify-between md:hidden">
          <button
            type="button"
            onClick={onOpenSidebar}
            className="grid h-11 w-11 place-items-center rounded-xl bg-white text-black shadow-sm ring-1 ring-slate-200"
          ...
          <button
            ...
            className={cn(
              "grid h-11 w-11 place-items-center rounded-xl shadow-sm ring-1 transition",
              meta.bellActive
        ...
        <div className="mt-6 flex flex-col gap-4 md:mt-0 lg:flex-row lg:items-center lg:justify-between">
          {/* Left */}
