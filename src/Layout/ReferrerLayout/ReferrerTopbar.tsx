    ...
    return (
        <header className="h-[100px] w-full bg-white border-b border-slate-100 flex items-center justify-between px-10 relative z-50">
            <div className="flex flex-col flex-1">
                <h2 className="text-xl font-black text-slate-800 tracking-tighter uppercase leading-none mb-1">Partner Overview</h2>
                <p className="text-[13px] font-bold text-slate-400">welcome back, alex, your portfolio is growing.</p>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                {/* New Referral Button */}
                <button className="flex items-center gap-2 bg-black text-white px-5 h-11 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-200">
