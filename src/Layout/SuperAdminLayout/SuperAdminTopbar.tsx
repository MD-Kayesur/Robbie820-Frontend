    ...
    return (
        <header className="h-[100px] w-full bg-white border-b border-slate-100 flex items-center justify-between px-10 relative z-50">
            <div className="flex items-center gap-10 flex-1">
                <h2 className="text-xl font-black text-slate-800 tracking-tighter hidden lg:block">Platform Overview</h2>
            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex items-center gap-4 cursor-pointer hover:bg-slate-50 p-2 rounded-2xl transition-all">
                    <div className="flex flex-col items-end mr-1">
                        <h4 className="font-black text-slate-900 leading-tight">Alexander Thomas</h4>
                        <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Super Admin</p>
                    </div>
