    ...
    <div className="w-full">
      {step === "role" ? (
        ...
        <div className="mx-auto w-full max-w-sm">
          <div className="rounded-3xl border border-[#3A86FF80] bg-transparent px-4 py-6 sm:px-6 sm:py-8.5">
            <button
              type="button"
              onClick={handleBack}
              className="mb-10 mx-auto flex items-center gap-2 uppercase text-[#00B4FE] transition hover:opacity-80 leading-6"
            >
            ...
            <div className="text-center">
              ...
              <p className="mt-3 font-light leading-6 text-[#9A9A9A]">
                {step === "account"
            ...
            <button
              ...
              onClick={handleNext}
              disabled={loading}
              className="mt-8.5 inline-flex h-14 w-full items-center justify-center gap-3 rounded-xl bg-[#16AAF5] text-[16px] font-medium text-white transition hover:bg-[#0f9ae2] disabled:cursor-not-allowed disabled:opacity-70"
            >
              {loading ? (
            ...
            <div className="mt-8.5 text-center text-sm text-[#5F5F5F]">
