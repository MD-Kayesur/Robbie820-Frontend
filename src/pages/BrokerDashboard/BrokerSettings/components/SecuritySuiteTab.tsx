  ...
  return (
    <div className="space-y-5">
      <section className="rounded-[20px] border border-[#DADDE3] bg-white p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)] sm:p-6">
        ...
        <button
          type="button"
          className="mt-8 inline-flex h-11.5 w-full cursor-default items-center justify-center rounded-[10px] bg-[#0B1736] px-6 text-[15px] font-medium text-white sm:h-12 sm:w-auto sm:text-[16px]"
        >
          Update Password
        </button>
      </section>
      ...
      <section className="rounded-[20px] border border-[#DADDE3] bg-white p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)] sm:p-6">
        ...
        <div className="mt-6 flex flex-col gap-5 sm:flex-row">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[18px] bg-[#E8F8EE] sm:h-15 sm:w-15">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-155 text-[14px] leading-7 text-[#6B7280] sm:text-[16px] sm:leading-8">
            ...
            <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center">
              <button
                type="button"
                className="inline-flex h-11.5 w-full items-center justify-center rounded-xl border border-[#E5E7EB] bg-white px-6 text-[15px] font-medium text-[#6B7280] transition hover:bg-slate-50 sm:h-12 sm:w-auto sm:text-[16px]"
              >
                Manage MFA Methods
              </button>
              ...
              <button
                ...
                onClick={onToggle2FA}
                className={cn(
                  "text-left text-[15px] font-medium transition hover:opacity-80 sm:text-[16px]",
