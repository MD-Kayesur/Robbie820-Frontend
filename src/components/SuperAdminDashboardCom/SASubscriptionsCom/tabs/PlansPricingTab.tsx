        ...
        {plans.map((p) => (
          ...
          >
            ...
            <div className="mt-5 space-y-2 text-sm">
              <div className="flex items-center justify-between gap-3 text-[#4A5565]">
            ...
            <div className="mt-5 border-t border-slate-200 pb-6 pt-4">
            ...
            <button
              ...
              className="mt-auto flex w-full items-center justify-center rounded-xl border border-slate-200 bg-white py-2.5 text-sm font-semibold text-slate-800 hover:bg-slate-50"
            >
