        ...
        <>
          ...
          >
            ...
            >
              ...
              <div className="px-4 pb-4 pt-4 md:px-8 md:pb-10 md:pt-6 overflow-y-auto">
                <div className="space-y-3 md:space-y-4">
                  {list.map((r) => (
                    <div
                      key={r.label}
                      className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between rounded-2xl bg-slate-50/60 px-4 py-4 md:px-7 md:py-7"
                    >
