  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-4 sm:p-6">
      <div className="flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-[22px] border border-[#CBD5E1] bg-[#F3FAFF] shadow-[0_30px_80px_rgba(0,0,0,0.22)]">
        <div className="border-b border-[#D8EAF7] px-4 py-4 sm:px-6 sm:py-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <span className="truncate text-[13px] text-[#374151] sm:text-sm">
            ...
            <button
              type="button"
              onClick={onDownload}
              className="h-10 w-full items-center justify-center gap-2 rounded-md bg-[#020617] px-3 text-[13px] font-medium text-white transition hover:bg-slate-900 sm:w-auto hidden sm:inline-flex"
            >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-6">
          <div className="rounded-xl border border-[#D8EAF7] bg-white p-4 sm:p-7">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <h2 className="text-[22px] font-semibold tracking-[-0.03em] text-[#111827] sm:text-[28px]">
                  {invoice.fromName}
                </h2>
            ...
            <div className="mt-5 border-t border-[#E5E7EB] pt-5">
              ...
              <p className="mt-1 text-[18px] font-semibold text-[#111827] sm:text-[22px]">
                {invoice.billToName}
              </p>
              <p className="mt-1 text-[14px] text-[#6B7280]">
            ...
            <div className="mt-4 flex justify-end">
              <div className="w-full max-w-full space-y-2 text-[14px] text-[#6B7280] sm:max-w-65">
