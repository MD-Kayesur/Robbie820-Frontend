    ...
    return (
        <footer className="bg-[#DFF5FF] pt-20 pb-10 px-6 md:px-12 text-[#2D3E50]">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="max-w-md text-[15px] font-medium leading-relaxed opacity-80">
                            Automated Referral Commission Management For Brokers, And Referral Partners. Built For Accuracy, Transparency, And Trust.
                        </p>
                    ...
                    <div className="flex flex-col md:items-end justify-start space-y-6">
                        <span className="text-sky-500 font-black text-[15px] uppercase tracking-wider">Get the app</span>
                ...
                {/* Divider */}
                <div className="h-[1px] bg-sky-200 w-full mb-8 opacity-50" />
                ...
                <div className="flex flex-col md:row items-center justify-between gap-6 md:flex-row">
                    ...
                    <div className="flex flex-col items-center md:items-end gap-3 order-1 md:order-2">
                        <div className="flex gap-4">
                            <a href="#" className="w-9 h-9 bg-slate-300/30 rounded-md flex items-center justify-center hover:bg-sky-500 hover:text-white transition-all duration-300 text-slate-500">
                        ...
                        <span className="text-[11px] font-bold opacity-60 uppercase tracking-widest">Follow us on Social Media</span>
                    </div>
                </div>
            </div>
        </footer>
