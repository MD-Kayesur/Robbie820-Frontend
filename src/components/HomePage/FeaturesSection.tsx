...
const features = [
    {
        ...
        description: "Backend-Driven Calculations Ensure 100% Accuracy. No More Disputes Or Manual Errors.",
        icon: Calculator,
        color: "bg-sky-50 text-sky-500"
    },
    {
        title: "Role-Based Dashboards",
        description: "Customized, Role-Based Dashboards Designed For Brokers, Referrers, And Team Members.",
        icon: Users,
    ...
    },
    {
        ...
        description: "Stay Updated With Instant Email And SMS Alerts For Deal Progress And Commission Updates.",
        icon: Bell,
        color: "bg-orange-50 text-orange-500"
    },
    {
        title: "Reporting & Insights",
        description: "Track Referrals With Year-Over-Year Trends, Flexible Dates, And Exportable Analytics.",
        icon: BarChart3,
        color: "bg-blue-50 text-blue-500"
    },
    {
        title: "Lead Management",
        description: "Automatically Sync Referral Leads To Your CRM Via API And Zapier For Seamless Tracking And Follow-Ups.",
        icon: LinkIcon,
