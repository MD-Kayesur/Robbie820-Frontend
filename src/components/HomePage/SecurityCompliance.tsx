...
const securityFeatures = [
    {
        ...
        description: "Each User Sees Only What They're Authorized To Access. Sensitive Financial Data Stays Protected.",
        icon: Lock,
        color: "bg-blue-50 text-blue-500"
    },
    {
        title: "Privacy-First Design",
        description: "Referral Partners See Their Earnings Without Accessing Confidential Loan Details Or Client Information.",
        icon: EyeOff,
    ...
    },
    {
        ...
        description: "Every Referral Logged With Audit Trails, Agreement Storage, And Document Uploads For Compliance.",
        icon: FileText,
...
const SecurityCompliance = () => {
    return (
        <section id="security" className="py-24 bg-slate-50/30 overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="flex-1 order-1 lg:order-2">
                        <div className="mb-14">
                            ...
                            >
                                Your Financial Data Deserves Enterprise-Grade Protection. We Take Security Seriously So You Can Focus On Growing Your Business.
                            </motion.p>
                        </div>
                        ...
                        <div className="space-y-8">
                            {securityFeatures.map((feature, idx) => (
                                ...
                                >
                                    <div className={`w-14 h-14 ${feature.color} rounded-2xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-sm`}>
