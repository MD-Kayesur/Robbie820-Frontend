...
const steps = [
    {
        ...
        description: "Create your account and select the subscription plan that fits your business needs."
    },
    {
        number: "2",
        title: "Track & Manage Deals",
        description: "Referral partners submit deals; brokers track progress, update agreements, referrers."
    },
    {
        number: "3",
        title: "Auto-Calculate Commissions",
        description: "Our system automatically calculates accurate commissions based on deal parameters."
    },
    {
        number: "4",
        title: "Track & Get Paid",
        description: "Track referral earnings in real-time while brokers handle payments directly."
    }
];
...
const HexagonIcon = ({ number }: { number: string }) => (
    <div className="relative w-14 h-14 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <span className="relative z-10 text-2xl font-black text-white">{number}</span>
    </div>
);
