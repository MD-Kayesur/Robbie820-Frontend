...
export default function FullPageEmailVerificationSuccess() {
    ...
    >
      ...
      <div className="w-full max-w-lg mb-12">
        ...
        >
          ...
          />
          {/* Check mark */}
          <circle cx="400" cy="350" r="40" className="fill-green-500" />
          <path
            d="M385 350L395 360L420 330"
      ...
      <p className="text-center text-lg opacity-70 mb-8 dark:text-white max-w-md">
        Your email has been confirmed. You can now continue to your account and enjoy all features.
      </p>

      {/* Call to Action */}
      <button
        onClick={() => navigate("/user/practice")}
        className="px-8 py-4 rounded-2xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all"
      >
        Go to Dashboard
      </button>
    </div>
