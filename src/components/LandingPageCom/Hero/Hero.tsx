...
const Hero = ({ onGetStarted }: HeroProps) => {
    return (
        <main className="relative clash">
            <CommonWrapper className={"pt-64 pb-16 md:pl-[150px]"}>
                ...
                <div className=" mx-auto flex flex-col lg:flex-row items-center ">
                    ...
                    <div className="flex-1 text-center lg:text-left space-y-10">
                        <div className="space-y-6">
                            <h1 className="text-2xl md:text-3xl lg:text-[3rem] font-normal leading-none tracking-tight text-[#0F172A]">
                                Automate Referral  Commissions{" "}
                            ...
                            <p className="text-xl md:text-2xl text-slate-500 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-5">
                            ...
                            <Button
                                variant="outline"
                                className="w-full sm:w-auto bg-white hover:bg-slate-50  hover:text-sky-500 font-bold h-16 px-12 rounded-2xl text-xl border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 active:scale-95"
                            >
                                Watch Demo
                            </Button>
                        </div>

                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8 text-slate-500 font-semibold">
