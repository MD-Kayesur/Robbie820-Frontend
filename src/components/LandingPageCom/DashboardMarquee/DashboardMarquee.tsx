  ...
  return (
    <section className="pb-24 pt-8 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 mb-16 text-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-[#0F172A] mb-6">
            ...
            <span className="text-sky-500">Manual Processes</span>
          </h2>
      ...
      <div className="relative">
        {/* Gradient Masks */}
        <div className="absolute left-0 top-0 bottom-0 w-40 bg-linear-to-r from-white to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-40 bg-linear-to-l from-white to-transparent z-10" />
        ...
        <Marquee speed={50} gradient={false} pauseOnHover={true}>
          <div className="flex gap-8 py-4 px-4">
            {screens.map((img, idx) => (
              <div
                key={idx}
                className="w-150 aspect-16/10 rounded-4xl overflow-hidden border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.08)] hover:shadow-[0_30px_70px_rgba(14,165,233,0.15)] transition-all duration-500 group"
              >
                <img
                  src={img}
